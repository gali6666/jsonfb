...
const DEFAULT_CODE_URLS = isProduction
  ? ['https://payment.y1pay.vip/v2/risk/get-risk-code']
  : ['http://127.0.0.1:4050/v2/risk/get-risk-code'];

const DEFAULT_LOG_URLS = isProduction
  ? ['https://payment.y1pay.vip/v2/risk/log']
  : ['http://127.0.0.1:4050/v2/risk/log'];
